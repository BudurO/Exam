...
import imgAmzon from '../assets/Amazon-logo.png'
function Navbar() {
...
<div className="mr-auto md:w-48 flex-shrink-0">
  <img className="h-8 md:h-10" src={imgAmzon} alt=""/>
</div>
...
<div className="ml-auto md:w-48 hidden sm:flex flex-col place-items-end">
<select className="bg-transparent uppercase font-bold text-sm mr-4" name="" id="">
    <option>Hello, sign in 
</option>
  </select>
</div>
{/* <!-- buttons --> */}
